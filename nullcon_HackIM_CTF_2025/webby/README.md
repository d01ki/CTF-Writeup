...
アクセスしても/?source動作しません。 とすべきです/?source=1。すると、サーバーのソースが表示されます。
...
```
(venv) iniad@localhost:~/ctf/CTF-Writeup/nullcon_HackIM_CTF_2025/webby$ python3 solve.py 

・
・
・
{'Content-Type': 'text/html; charset=utf-8', 'Set-Cookie': 'webpy_session_id=529df4ef2b0c83651f955a86eddd23ae8f24a8ce; HttpOnly; Path=/'} webpy_session_id=529df4ef2b0c83651f955a86eddd23ae8f24a8ce
No flag
{'Content-Type': 'text/html; charset=utf-8', 'Set-Cookie': 'webpy_session_id=a9535dc2561b53f763ffe976b769ba7b67c7937d; HttpOnly; Path=/'} webpy_session_id=a9535dc2561b53f763ffe976b769ba7b67c7937d
<html>
        <head>
